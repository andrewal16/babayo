        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Select the perfect plan for your journey in business and investment learning
            </p>
          </div>
                ...
                <div className={`bg-gradient-to-br ${plan.color} p-8 h-full flex flex-col`}>
                  <div className="flex-1">
                    ...
                    <div className="space-y-4">
                      <p className="text-lg font-semibold text-white mb-4">Benefits:</p>
      ...
      <div className="bg-[#001d5b] rounded-2xl overflow-hidden shadow-2xl">
        ...
        <div className="p-8 bg-gradient-to-b from-[#001d5b] to-[#002b87]">
          <div className="relative flex items-center max-w-2xl mx-auto">
            ...
            />
            <button 
              className="absolute right-2 px-8 py-3 bg-white text-[#001d5b] rounded-lg font-semibold hover:bg-gray-100 transition-colors duration-300 shadow-lg"
            >
              Apply
            </button>
          </div>
